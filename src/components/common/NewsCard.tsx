<div data-reveal class="fade-up blog_card flex gap-4">
          <div class="blog_image w-[120px] shrink-0">
            <img src="/blo_thumb.png" class="w-full h-auto object-cover" />
          </div>
          <div class="blog_body">
            <h4 class="mt-2">Quick Read</h4>
            <span class="small text-sm gradient-text">Report | 5 min read</span>
            <p class="pt-[5px]">Lorem ipsum dolor sit amet consectetur. Volutpat lacus.</p>
            <span class="blog_date pt-[5px] text-sm flex gap-2 items-center">
              <svg
                width="12"
                height="12"
                viewBox="0 0 12 12"
